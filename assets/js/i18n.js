...
(function (global) {
  ...
  const dict = {
    zh: {
      ...
      'seo.home.description': '快码 Cursor 号池支持按需租用 Cursor 账号，额度随用随取，无限续杯，普通 Auto 模型 0.2 元/刀、高级模型 1 元/刀，每月低消 30 元，联系客服领取试用。',
      ...
      'pricing.lead': '按实际使用额度收费，每月低消 30 元。普通 Auto 模型 0.2 元 / 刀，高级模型 1 元 / 刀。',
    ...
    en: {
      ...
      'seo.home.description': 'KuaiMa Cursor Pool offers on-demand Cursor account rental and unlimited refills, with the Auto model at ¥0.2 per dollar, advanced models at ¥1 per dollar and a ¥30 monthly minimum. Contact support for a trial.',
      ...
      'pricing.lead': 'Usage-based billing with a ¥30 monthly minimum. The Auto model is ¥0.2 per dollar, and advanced models are ¥1 per dollar.',
