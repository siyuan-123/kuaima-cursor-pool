...
(function (global) {
  ...
  const dict = {
    zh: {
      ...
      'wechat.eyebrow': '微信客服',
      'wechat.title': '扫码添加客服',
      'wechat.promo': '加微信 · 首冲50送10刀',
      'wechat.desc': '下载、充值、开票或使用问题，扫码添加客服。备用 QQ：1051522712。',
      'wechat.copy': '复制备用QQ',
    ...
    en: {
      ...
      'wechat.promo': 'Add WeChat · top up 50, get 10 bonus dollars',
      'wechat.desc': 'For download, top-up, invoicing or setup questions, scan the QR code. Backup QQ: 1051522712.',
