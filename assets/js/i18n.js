...
(function (global) {
  ...
  const dict = {
    zh: {
      ...
      'seo.home.description': '快码 Cursor 号池支持按需租用 Cursor 账号，额度随用随取，无限续杯，普通 Auto 模型 0.2 元/刀、高级模型 1.3 元/刀，每月低消 30 元，联系客服领取试用。',
      'seo.tutorial.title': 'Cursor 号池使用教程 | 快码 Cursor 号池',
      'seo.tutorial.description': '快码 Cursor 号池使用教程：提供飞书文字版教程与抖音视频教程，快速了解客户端下载安装、号池设置、账号切换与常见问题。',
      // Nav
      'nav.home': '首页',
      'nav.tutorial': '使用教程',
      'nav.download': '下载',
      'nav.contact': '联系客服',
      // Hero
      'hero.badge': '无限续杯 · 每月低消 30 元 · 按额度收费',
      'hero.title.line1': 'Cursor 号池｜按需租用',
      'hero.title.line2': '额度无限续杯',
      'hero.title.line3': '联系客服，领取试用！',
      'hero.lead': 'Cursor 号池，额度随用随取。不再反复注册账号，不再盯着额度焦虑。每月低消 30 元，达到低消后按实际用量计费。',
      ...
      'hero.price.auto.value': '0.2 元 / 刀',
      'hero.price.advanced.label': '高级模型',
      'hero.price.advanced.value': '1.3 元 / 刀',
      'hero.price.mode.label': '计费方式',
      'hero.price.mode.value': '每月低消 30 元 · 按额度收费',
      'hero.hint': '不确定是否适合？先加客服领取试用，跑通后再充值。',
      // WeChat Floating Support
      'wechat.aria': '微信客服',
      'wechat.toggle': '打开客服弹窗',
      'wechat.close': '关闭客服弹窗',
      'wechat.handle': '客服',
      'wechat.eyebrow': '微信客服',
      'wechat.title': '扫码添加客服',
      ...
      'wechat.dotHint': '点我领取试用 →',
      // 下载助手（移动端提示 / Linux 或未知系统选择器）
      'download.helper.aria': '下载助手',
      'download.helper.close': '关闭下载助手',
      'download.helper.mobileTitle': '请用电脑访问下载',
      'download.helper.mobileDesc': 'Cursor 客户端仅支持 Windows / macOS。请用电脑访问本页，或复制下方链接到电脑浏览器打开。',
      'download.helper.copyWin': '复制 Windows 下载链接',
      'download.helper.copyMac': '复制 macOS 下载链接',
      'download.helper.chooseTitle': '请选择你的系统',
      'download.helper.chooseDesc': '我们没能识别出你的系统，请手动选择对应的版本。',
      'download.helper.pickWin': 'Windows 版',
      'download.helper.pickMac': 'macOS 版',
      // Features
      'pool.eyebrow': '模式说明',
      ...
      'features.f4.desc': '每月低消 30 元，达到低消后按模型实际用量和对应单价计费。',
      ...
      'pricing.lead': '按实际使用额度收费，每月低消 30 元。普通 Auto 模型 0.2 元 / 刀，高级模型 1.3 元 / 刀。',
      'pricing.point1.title': '普通 Auto 模型',
      'pricing.point1.desc': '0.2 元 / 刀，适合日常代码补全、问答和轻量开发。',
      'pricing.point2.title': '高级模型',
      'pricing.point2.desc': '1.3 元 / 刀，适合复杂任务、长上下文和更高质量模型需求。',
      'pricing.point3.title': '无限续杯',
      'pricing.point3.desc': '额度不足时可持续续杯，减少开发中断和额度焦虑。',
      'pricing.point4.title': '按额度收费',
      'pricing.point4.desc': '按模型实际用量和对应单价核算，费用明细清晰透明，便于控制开发成本。',
      'pricing.point5.title': '权益保障',
      'pricing.point5.desc': '为确保正常用户能够分配到账号并正常使用，我们设置了每月 30 元低消门槛；当月实际用量未满 30 元按 30 元计费，达到 30 元后按实际用量计费。',
      // CTA
      'cta.title': '先试用，再决定',
      ...
      'tutorial.title': 'Cursor 号池使用教程',
      'tutorial.lead': '建议先看飞书文字版按步骤操作，需要快速了解时再看抖音视频；看不懂也可以直接联系客服领取试用。',
      'tutorial.videoSection.eyebrow': '视频版教程',
      'tutorial.videoSection.title': '再看视频，快速了解流程',
      'tutorial.videoSection.lead': '适合想快速上手的用户，点击后跳转抖音观看。',
      'tutorial.textSection.eyebrow': '文字版教程',
      'tutorial.textSection.title': '想按步骤操作，看飞书图文说明',
      'tutorial.textSection.lead': '适合边看边设置，包含下载安装、号池设置、账号启用切换与常见问题。',
      ...
      'tutorial.text.title': '快码客户端文字版教程',
      'tutorial.text.desc': '跳转飞书查看图文步骤，包含下载安装、号池设置、账号启用切换与常见问题。',
      'tutorial.text.watch': '点击查看飞书文字版',
    ...
    en: {
      ...
      'seo.home.description': 'KuaiMa Cursor Pool offers on-demand Cursor account rental and unlimited refills, with the Auto model at ¥0.2 per dollar, advanced models at ¥1.3 per dollar and a ¥30 monthly minimum. Contact support for a trial.',
      'seo.tutorial.title': 'Cursor Pool Tutorial | KuaiMa Cursor Pool',
      'seo.tutorial.description': 'KuaiMa Cursor Pool tutorials with a Feishu text guide and Douyin videos for download, setup, pool switching and FAQs.',
      'nav.home': 'Home',
      'nav.tutorial': 'Tutorial',
      'nav.download': 'Download',
      'nav.contact': 'Contact',
      'hero.badge': 'Unlimited Refill · ¥30 Monthly Minimum · Pay by Usage',
      ...
      'hero.lead': 'Cursor Pool gives you quota when you need it. No repeated account registration, no quota anxiety. The monthly minimum is ¥30; once reached, billing follows actual usage.',
      ...
      'hero.price.auto.value': '¥0.2 / dollar',
      'hero.price.advanced.label': 'Advanced Models',
      'hero.price.advanced.value': '¥1.3 / dollar',
      'hero.price.mode.label': 'Billing',
      'hero.price.mode.value': '¥30 monthly minimum · Pay by quota',
      'hero.hint': 'Not sure yet? Add support for a trial first, then top up after it works for you.',
      'wechat.aria': 'WeChat Support',
      'wechat.toggle': 'Open support modal',
      'wechat.close': 'Close support modal',
      ...
      'wechat.dotHint': 'Click here for free trial →',
      'download.helper.aria': 'Download helper',
      'download.helper.close': 'Close download helper',
      'download.helper.mobileTitle': 'Please open this on a desktop',
      'download.helper.mobileDesc': 'Cursor client is only available for Windows / macOS. Open this page on a desktop, or copy the link below into a desktop browser.',
      'download.helper.copyWin': 'Copy Windows download link',
      'download.helper.copyMac': 'Copy macOS download link',
      'download.helper.chooseTitle': 'Pick your operating system',
      'download.helper.chooseDesc': 'We could not detect your OS automatically. Please choose the right build.',
      'download.helper.pickWin': 'Windows',
      'download.helper.pickMac': 'macOS',
      ...
      'features.f4.desc': 'The monthly minimum is ¥30; once reached, billing follows actual model usage and the published rates.',
      ...
      'pricing.lead': 'Usage-based billing with a ¥30 monthly minimum. The Auto model is ¥0.2 per dollar, and advanced models are ¥1.3 per dollar.',
      'pricing.point1.title': 'Auto Model',
      'pricing.point1.desc': '¥0.2 per dollar, suitable for daily completion, Q&A and lightweight development.',
      'pricing.point2.title': 'Advanced Models',
      'pricing.point2.desc': '¥1.3 per dollar, suitable for complex tasks, longer context and higher-quality model needs.',
      ...
      'pricing.point4.desc': 'Charges are calculated from actual model usage at the published rates, keeping costs clear and predictable.',
      'pricing.point5.title': 'Service Availability',
      'pricing.point5.desc': 'To keep accounts available for regular users, we set a ¥30 monthly minimum. Monthly usage below ¥30 is billed at ¥30; once usage reaches ¥30, billing follows actual usage.',
      ...
      'tutorial.title': 'Cursor Pool Tutorial',
      'tutorial.lead': 'Start with the Feishu text guide for step-by-step setup, then watch the Douyin videos for a quick overview. If it is still unclear, contact support for a trial.',
      'tutorial.videoSection.eyebrow': 'Video Tutorials',
      'tutorial.videoSection.title': 'Then watch videos for a quick overview',
      'tutorial.videoSection.lead': 'Best for users who want to get started quickly. Click to watch on Douyin.',
      'tutorial.textSection.eyebrow': 'Text Guide',
      'tutorial.textSection.title': 'Follow the Feishu guide step by step',
      'tutorial.textSection.lead': 'Best for setting it up while reading, including download, pool setup, account switching and FAQs.',
      ...
      'tutorial.text.title': 'KuaiMa Client Text Guide',
      'tutorial.text.desc': 'Open the Feishu guide for step-by-step instructions, including download, pool setup, account switching and FAQs.',
      'tutorial.text.watch': 'Open Feishu Text Guide',
