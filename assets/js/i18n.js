...
(function (global) {
  ...
  const dict = {
    zh: {
      ...
      'tutorial.step1.title': '先在软件充值',
      'tutorial.step1.desc': '打开快码客户端，在充值页面选择金额完成支付，余额会立即到账并永久有效。',
      'tutorial.step2.title': '开启 cursor 无感换号',
      'tutorial.step2.desc': '在客户端中开启「无感换号」开关，软件会自动接管 Cursor 的账号配置，无需任何手动操作。',
      'tutorial.step3.title': '换号使用',
      'tutorial.step3.desc': '正常使用 Cursor，当前账号额度耗尽时,快码会自动切换到下一个账号,继续无缝写代码。',
    ...
    en: {
      ...
      'nav.contact': 'Contact',
      'hero.badge': 'Official Accounts · Pay-per-Dollar · No Monthly Fee',
      ...
      'tutorial.step1.title': 'Top up in the App',
      'tutorial.step1.desc': 'Open the KuaiMa client, choose an amount on the top-up page, and complete payment. Your balance is credited instantly and never expires.',
      'tutorial.step2.title': 'Enable Seamless Switching',
      'tutorial.step2.desc': 'Toggle on "Seamless Switching" in the client. KuaiMa takes over Cursor account config automatically, no manual setup needed.',
      'tutorial.step3.title': 'Use Cursor as Usual',
      'tutorial.step3.desc': 'Just code. When the current account hits its limit, KuaiMa silently switches to the next one and you keep coding without interruption.',
